 ...
 * compatibility wrapper will be removed in the next major release.
 */
export const BadgesButton: React.FC<BadgesButtonProps> = ({
    ...
    React.useEffect(() => {
        warnDeprecation(
            '`BadgesButton` is deprecated. Use `AchievementsWidget` instead. `BadgesButton` will be removed in the next major release.'
        );
    }, []);
